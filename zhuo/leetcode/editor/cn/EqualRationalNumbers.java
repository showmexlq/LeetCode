...
//
// 有理数 最多可以用三个部分来表示：整数部分 <IntegerPart>、小数非重复部分 <NonRepeatingPart> 和小数重复部分 <(><
 ...
 * 相等的有理数
 * @author zhuo
 * @date 2025-06-09 14:58:29
 */
public class EqualRationalNumbers{
    
    public static void main(String[] args) {
        Solution solution = new EqualRationalNumbers().new Solution();
    }
